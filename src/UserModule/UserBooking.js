                        ...
                        <div className="col-8">
                            ...
                            <div className="row ">
                                ...
                                <div className="col-10 mt-3 d-grid gap-2 d-md-flex">
                                    <button type="button" className="btn btn-dark btn-lg" onClick={() => navigate("/userrooms")}>Back</button>
                    ...
                    <div className="row">
                        ...
                        <div className="row mt-5">
                            ...
                            <div className="col-10 mt-3 d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <button type="button" className="btn btn-dark btn-lg" onClick={() => navigate("/userrooms")}>Cancel</button>
                            </div>
                        </div>
                    </>
                )}
